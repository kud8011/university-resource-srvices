...
<?php
 ...
 ?>
<form action="guest_house_booking_update.php" method="post" name="guest_house_booking" id="formID">
...
?>
      ...
      <tr>
        ...
        <td><textarea name="ghbooking_description" id="ghbooking_description" class="form-control validate[required]" value="<?php echo $row['ghbooking_description'];?>"></textarea></td>
      </tr>
      <tr>
        <td>Booking Date </td>
