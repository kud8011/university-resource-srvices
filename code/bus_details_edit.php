...
<form action="bus_details_update.php" method="post" id="formID" enctype="multipart/form-data" name="form1">
  ...
  <div align="center">
    ...
    <table width="508" border="1">
      <tr>
        ...
        <td width="248"><input name="bus_no" type="text" class="form-control validate[required]" id="bus_no" value="<?php echo $row['bus_no'];?>"></td>
      </tr>
      <tr>
        <td>No of seats </td>
