...
<form action="guest_house_update.php" method="post" enctype="multipart/form-data" name="guest_house" id="guest_house">
<input type="hidden" name="guest_house_id" value="<?php echo $row['guest_house_id'];?>">
  ...
  <table width="472" border="1" align="center">
    ...
    <tr>
      <td>Description</td>
      <td><textarea name="description" id="description" class="form-control validate[required,custom[onlyLetter]]" value="<?php echo $row['description'];?>"></textarea></td>
    </tr>
    <tr>
      <td>Location</td>
	...
	<tr>
      <td>Image</td>
      <td><input name="image" type="file" id="image" class="form-control validate[required,custom[Image]]" value="<?php echo $row['image'];?>"></td>
    </tr>
    <tr>
