...
<?php
 ...
 ?>
<form action="bus_booking_update.php" method="post" name="bus_booking" id="bus_booking">
<input type="hidden" name="bus_booking_id" value="<?php echo $row['bus_booking_id'];?>">
  ...
  <table width="440" border="1" align="center">
    <tr>
      <td width="218">Bus Id </td>
      <td width="206"><input name="bus_id" type="text" class="form-control validate[required,custom[onlyNumber]]" id="bus_id" value="<?php echo $row['bus_id']; ?>"></td>
    </tr>
    <tr>
      <td>Customer Id </td>
      <td><input name="customer_id" type="text" class="form-control validate[required,custom[onlyNumber]]" id="customer_id" value="<?php echo $row['customer_id']; ?>"></td>
    </tr>
    <tr>
      <td>No of seats </td>
    ...
    <tr>
      ...
      <td><textarea name="bus_booking_description" class="form-control validate[required,custom[onlyLetter]]" id="bus_booking_description" value="<?php echo $row['bus_booking_description']; ?>"></textarea></td>
    </tr>
    <tr>
