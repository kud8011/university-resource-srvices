...
<form action="customer_details_update.php" method="post" name="customer_details" id="customer_details">
  ...
  <div align="center">
    ...
    <table width="442" border="1">
      ...
      <tr>
        ...
        <td><textarea name="customer_address" id="customer_address" class="form-control validate[required,custom[onlyLetter]]" value="<?php echo $row['customer_address']; ?>"></textarea></td>
      </tr>
      <tr>
        <td>Customer City </td>
