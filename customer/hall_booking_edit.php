...
<form action="hall_booking_update.php" method="post" name="hall_booking" id="hall_booking">
<input type="hidden" name="hall_booking_id" value="<?php echo $row['hall_booking_id'];?>">
  ...
  <table width="459" border="1" align="center">
    <tr>
      <td width="214">Hall Id </td>
      <td width="229"><input name="hall_id" type="text" class="form-control validate[required,custom[onlyNumber]]" id="hall_id" value="<?php echo $row['hall_id'];?>"></td>
    </tr>
    <tr>
      <td>Customer Id </td>
    ...
    <tr>
      ...
      <td><textarea name="booking_description" id="booking_description" class="form-control validate[required,custom[onlyLetter]]" value="<?php echo $row['booking_description'];?>"></textarea>      </td>
    </tr>
    <tr>
      <td>Booking Date </td>
